def is_on_list(codigo_ratreio, lista):
    return codigo_ratreio in lista


def add_tracking_code(codigo_rastreio, lista):
    return lista.append(codigo_rastreio)


def remove_tracking_code(codigo_rastreio, lista):
    return lista.remove(codigo_rastreio)
...
def sum_two_lists(lista_1, lista_2):
    lista_1 = len(lista_1)
    lista_2 = len(lista_2)
    return lista_1 + lista_2


def join_two_lists(lista_1, lista_2):
    return lista_1 + lista_2
...
def count_in_list(valor, last_sales):
    return last_sales.count(valor)
...
tracking_codes = ["JN426598162BR", "JN426598255BR", "JN426598247BR", "JN426598145BR", "JN426598057BR", "JN426598074BR",
                  "JN426598233BR", "JN426598220BR", "JN426598278BR", "JN426598281BR", "JN426598043BR", "JN426598030B"]
...
company_two_tracking_codes = ["JN426599534BR", "JN426599525BR", "JN426599517BR", "JN426598370BR", "JN426598410BR",
                              "JN426599401BR"]
